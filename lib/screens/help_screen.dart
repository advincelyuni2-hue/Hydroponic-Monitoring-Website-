...
class _HelpScreenState extends State<HelpScreen> {
  final HelpArticleService _service = HelpArticleService();
  ...
  Future<void> _edit([HelpArticle? article]) async {
    ...
    final result = await showDialog<HelpArticle>(
      ...
      builder: (context) => AlertDialog(
        title: Text(
            article == null ? 'Add help article' : 'Edit help article'),
        content: Column(
    ...
    if (result == null || result.title.isEmpty || result.body.isEmpty) {
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    final articles = _articles.isEmpty ? fallback : _articles;
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildSection('Tutorials',
                        articles.where((a) => a.type == 'tutorial').toList(), admin),
                    _buildSection('FAQs',
  ...
  Widget _buildSection(
      String title, List<HelpArticle> articles, bool admin) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
