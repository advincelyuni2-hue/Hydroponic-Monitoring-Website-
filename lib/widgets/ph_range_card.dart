...
class PhRangeCard extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text('pH range', style: AppTextStyles.sectionTitle),
              Container(
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(text: phRange.start.toStringAsFixed(1)),
                        ],
                      ),
                    ),
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(text: phRange.end.toStringAsFixed(1)),
                        ],
                      ),
                    ),
                  ],
